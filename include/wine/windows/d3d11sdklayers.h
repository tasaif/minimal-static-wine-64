/*** Autogenerated by WIDL 1.7.40 from d3d11sdklayers.idl - Do not edit ***/
...
void __RPC_STUB ID3D11InfoQueue_SetBreakOnID_Stub(
    ...
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
BOOL STDMETHODCALLTYPE ID3D11InfoQueue_GetBreakOnCategory_Proxy(
    ID3D11InfoQueue* This,
    D3D11_MESSAGE_CATEGORY Category);
void __RPC_STUB ID3D11InfoQueue_GetBreakOnCategory_Stub(
    ...
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
BOOL STDMETHODCALLTYPE ID3D11InfoQueue_GetBreakOnSeverity_Proxy(
    ID3D11InfoQueue* This,
    D3D11_MESSAGE_SEVERITY Severity);
void __RPC_STUB ID3D11InfoQueue_GetBreakOnSeverity_Stub(
    ...
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
BOOL STDMETHODCALLTYPE ID3D11InfoQueue_GetBreakOnID_Proxy(
    ID3D11InfoQueue* This,
    D3D11_MESSAGE_ID ID);
...
void __RPC_STUB ID3D11InfoQueue_SetMuteDebugOutput_Stub(
    ...
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
BOOL STDMETHODCALLTYPE ID3D11InfoQueue_GetMuteDebugOutput_Proxy(
    ID3D11InfoQueue* This);
