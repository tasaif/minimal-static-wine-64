/*** Autogenerated by WIDL 1.7.40 from metahost.idl - Do not edit ***/
...
#undef LoadLibrary
#endif
typedef enum __WIDL_metahost_generated_name_00000010 {
...
HRESULT STDMETHODCALLTYPE ICLRMetaHostPolicy_GetRequestedRuntime_Proxy(
    ICLRMetaHostPolicy* This,
    METAHOST_POLICY_FLAGS dwPolicyFlags,
    LPCWSTR pwzBinary,
    IStream *pCfgStream,
    ...
    REFIID riid,
    LPVOID *ppRuntime);
void __RPC_STUB ICLRMetaHostPolicy_GetRequestedRuntime_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE ICLRDebuggingLibraryProvider_ProvideLibrary_Proxy(
    ICLRDebuggingLibraryProvider* This,
    const WCHAR *pwszFileName,
    DWORD dwTimestamp,
    DWORD dwSizeOfImage,
    HMODULE *phModule);
void __RPC_STUB ICLRDebuggingLibraryProvider_ProvideLibrary_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE ICLRDebugging_OpenVirtualProcess_Proxy(
    ICLRDebugging* This,
    ULONG64 moduleBaseAddress,
    IUnknown *pDataTarget,
    ICLRDebuggingLibraryProvider *pLibraryProvider,
    ...
    CLR_DEBUGGING_VERSION *pVersion,
    CLR_DEBUGGING_PROCESS_FLAGS *pdwFlags);
void __RPC_STUB ICLRDebugging_OpenVirtualProcess_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE ICLRDebugging_CanUnloadNow_Proxy(
    ICLRDebugging* This,
    HMODULE hModule);
void __RPC_STUB ICLRDebugging_CanUnloadNow_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
