/*** Autogenerated by WIDL 1.7.40 from mimeole.idl - Do not edit ***/
...
/*** IMalloc methods ***/
static FORCEINLINE LPVOID IMimeAllocator_Alloc(IMimeAllocator* This,ULONG cb) {
    return This->lpVtbl->Alloc(This,cb);
}
static FORCEINLINE LPVOID IMimeAllocator_Realloc(IMimeAllocator* This,LPVOID pv,ULONG cb) {
    return This->lpVtbl->Realloc(This,pv,cb);
}
static FORCEINLINE void IMimeAllocator_Free(IMimeAllocator* This,LPVOID pv) {
    This->lpVtbl->Free(This,pv);
}
static FORCEINLINE ULONG IMimeAllocator_GetSize(IMimeAllocator* This,LPVOID pv) {
