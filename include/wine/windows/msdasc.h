/*** Autogenerated by WIDL 1.7.40 from msdasc.idl - Do not edit ***/
...
HRESULT STDMETHODCALLTYPE IDataSourceLocator_get_hWnd_Proxy(
    IDataSourceLocator* This,
    COMPATIBLE_LONG *phwndParent);
void __RPC_STUB IDataSourceLocator_get_hWnd_Stub(
    ...
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IDataSourceLocator_put_hWnd_Proxy(
    IDataSourceLocator* This,
    COMPATIBLE_LONG hwndParent);
void __RPC_STUB IDataSourceLocator_put_hWnd_Stub(
    ...
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IDataSourceLocator_PromptNew_Proxy(
    IDataSourceLocator* This,
    IDispatch **ppADOConnection);
void __RPC_STUB IDataSourceLocator_PromptNew_Stub(
    ...
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IDataSourceLocator_PromptEdit_Proxy(
    IDataSourceLocator* This,
    IDispatch **ppADOConnection,
    VARIANT_BOOL *pbSuccess);
...
HRESULT __stdcall IDBPromptInitialize_PromptDataSource_Proxy(
    IDBPromptInitialize* This,
    IUnknown *pUnkOuter,
    HWND hWndParent,
    DBPROMPTOPTIONS dwPromptOptions,
...
void __RPC_STUB IDBPromptInitialize_PromptDataSource_Stub(
    ...
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT __stdcall IDBPromptInitialize_PromptFileName_Proxy(
    IDBPromptInitialize* This,
    HWND hWndParent,
    ULONG dwPromptOptions,
    LPWSTR pwszInitialDirectory,
