/*** Autogenerated by WIDL 1.7.40 from objidl.idl - Do not edit ***/
...
/*** IMalloc methods ***/
static FORCEINLINE LPVOID IMalloc_Alloc(IMalloc* This,ULONG cb) {
    return This->lpVtbl->Alloc(This,cb);
}
static FORCEINLINE LPVOID IMalloc_Realloc(IMalloc* This,LPVOID pv,ULONG cb) {
    return This->lpVtbl->Realloc(This,pv,cb);
}
static FORCEINLINE void IMalloc_Free(IMalloc* This,LPVOID pv) {
    This->lpVtbl->Free(This,pv);
}
static FORCEINLINE ULONG IMalloc_GetSize(IMalloc* This,LPVOID pv) {
...
/*** IMallocSpy methods ***/
static FORCEINLINE ULONG IMallocSpy_PreAlloc(IMallocSpy* This,ULONG cbRequest) {
...
static FORCEINLINE ULONG IMallocSpy_PreRealloc(IMallocSpy* This,LPVOID pRequest,ULONG cbRequest,LPVOID *ppNewRequest,BOOL fSpyed) {
...
static FORCEINLINE ULONG IMallocSpy_PostGetSize(IMallocSpy* This,ULONG cbActual,BOOL fSpyed) {
