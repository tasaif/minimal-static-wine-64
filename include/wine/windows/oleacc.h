/*** Autogenerated by WIDL 1.7.40 from oleacc.idl - Do not edit ***/
...
/*** IAccIdentity methods ***/
static FORCEINLINE HRESULT IAccIdentity_GetIdentityString(IAccIdentity* This,DWORD dwIDChild,BYTE **ppIDString,DWORD *pdwIDStringLen) {
    return This->lpVtbl->GetIdentityString(This,dwIDChild,ppIDString,pdwIDStringLen);
}
#endif
#endif
...
/*** IAccPropServer methods ***/
static FORCEINLINE HRESULT IAccPropServer_GetPropValue(IAccPropServer* This,const BYTE *pIDString,DWORD dwIDStringLen,MSAAPROPID idProp,VARIANT *pvarValue,BOOL *pfHasProp) {
    return This->lpVtbl->GetPropValue(This,pIDString,dwIDStringLen,idProp,pvarValue,pfHasProp);
}
#endif
#endif
...
/*** IAccPropServices methods ***/
static FORCEINLINE HRESULT IAccPropServices_SetPropValue(IAccPropServices* This,const BYTE *pIDString,DWORD dwIDStringLen,MSAAPROPID idProp,VARIANT var) {
    return This->lpVtbl->SetPropValue(This,pIDString,dwIDStringLen,idProp,var);
}
static FORCEINLINE HRESULT IAccPropServices_SetPropServer(IAccPropServices* This,const BYTE *pIDString,DWORD dwIDStringLen,const MSAAPROPID *paProps,int cProps,IAccPropServer *pServer,AnnoScope AnnoScope) {
    return This->lpVtbl->SetPropServer(This,pIDString,dwIDStringLen,paProps,cProps,pServer,AnnoScope);
}
static FORCEINLINE HRESULT IAccPropServices_ClearProps(IAccPropServices* This,const BYTE *pIDString,DWORD dwIDStringLen,const MSAAPROPID *paProps,int cProps) {
    return This->lpVtbl->ClearProps(This,pIDString,dwIDStringLen,paProps,cProps);
}
...
static FORCEINLINE HRESULT IAccPropServices_SetHwndPropServer(IAccPropServices* This,HWND hwnd,DWORD idObject,DWORD idChild,const MSAAPROPID *paProps,int cProps,IAccPropServer *pServer,AnnoScope AnnoScope) {
    return This->lpVtbl->SetHwndPropServer(This,hwnd,idObject,idChild,paProps,cProps,pServer,AnnoScope);
}
static FORCEINLINE HRESULT IAccPropServices_ClearHwndProps(IAccPropServices* This,HWND hwnd,DWORD idObject,DWORD idChild,const MSAAPROPID *paProps,int cProps) {
    return This->lpVtbl->ClearHwndProps(This,hwnd,idObject,idChild,paProps,cProps);
}
static FORCEINLINE HRESULT IAccPropServices_ComposeHwndIdentityString(IAccPropServices* This,HWND hwnd,DWORD idObject,DWORD idChild,BYTE **ppIDString,DWORD *pdwIDStringLen) {
    return This->lpVtbl->ComposeHwndIdentityString(This,hwnd,idObject,idChild,ppIDString,pdwIDStringLen);
}
static FORCEINLINE HRESULT IAccPropServices_DecomposeHwndIdentityString(IAccPropServices* This,const BYTE *pIDString,DWORD dwIDStringLen,HWND *phwnd,DWORD *pidObject,DWORD *pidChild) {
    return This->lpVtbl->DecomposeHwndIdentityString(This,pIDString,dwIDStringLen,phwnd,pidObject,pidChild);
}
...
static FORCEINLINE HRESULT IAccPropServices_SetHmenuPropServer(IAccPropServices* This,HMENU hmenu,DWORD idChild,const MSAAPROPID *paProps,int cProps,IAccPropServer *pServer,AnnoScope AnnoScope) {
    return This->lpVtbl->SetHmenuPropServer(This,hmenu,idChild,paProps,cProps,pServer,AnnoScope);
}
static FORCEINLINE HRESULT IAccPropServices_ClearHmenuProps(IAccPropServices* This,HMENU hmenu,DWORD idChild,const MSAAPROPID *paProps,int cProps) {
    return This->lpVtbl->ClearHmenuProps(This,hmenu,idChild,paProps,cProps);
}
static FORCEINLINE HRESULT IAccPropServices_ComposeHmenuIdentityString(IAccPropServices* This,HMENU hmenu,DWORD idChild,BYTE **ppIDString,DWORD *pdwIDStringLen) {
    return This->lpVtbl->ComposeHmenuIdentityString(This,hmenu,idChild,ppIDString,pdwIDStringLen);
}
static FORCEINLINE HRESULT IAccPropServices_DecomposeHmenuIdentityString(IAccPropServices* This,const BYTE *pIDString,DWORD dwIDStringLen,HMENU *phmenu,DWORD *pidChild) {
    return This->lpVtbl->DecomposeHmenuIdentityString(This,pIDString,dwIDStringLen,phmenu,pidChild);
}
#endif
#endif
