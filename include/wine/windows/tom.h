/*** Autogenerated by WIDL 1.7.40 from tom.idl - Do not edit ***/
...
static FORCEINLINE HRESULT ITextRange_SetRange(ITextRange* This,LONG cpActive,LONG cpOther) {
    return This->lpVtbl->SetRange(This,cpActive,cpOther);
}
...
static FORCEINLINE HRESULT ITextSelection_SetRange(ITextSelection* This,LONG cpActive,LONG cpOther) {
    return This->lpVtbl->SetRange(This,cpActive,cpOther);
}
...
void __RPC_STUB ITextPara_SetSpaceBefore_Stub(
    ...
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE ITextPara_GetWidowControl_Proxy(
    ITextPara* This,
    LONG *pValue);
void __RPC_STUB ITextPara_GetWidowControl_Stub(
    ...
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE ITextPara_SetWidowControl_Proxy(
    ITextPara* This,
    LONG Value);
