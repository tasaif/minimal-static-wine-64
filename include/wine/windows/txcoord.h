/*** Autogenerated by WIDL 1.7.40 from txcoord.idl - Do not edit ***/
...
HRESULT STDMETHODCALLTYPE ITransactionImportWhereabouts_GetWhereabouts_Proxy(
    ...
    byte *rgbWhereabouts,
    ULONG *pcbUsed);
void __RPC_STUB ITransactionImportWhereabouts_GetWhereabouts_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE ITransactionExport_GetTransactionCookie_Proxy(
    ...
    byte *rgbTransactionCookie,
    ULONG *pcbUsed);
void __RPC_STUB ITransactionExport_GetTransactionCookie_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
