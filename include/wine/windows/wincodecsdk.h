/*** Autogenerated by WIDL 1.7.40 from wincodecsdk.idl - Do not edit ***/
...
typedef enum WICPersistOptions {
    ...
    WICPersistOptionsLittleEndian = 0x0,
    WICPersistOptionsBigEndian = 0x1,
    WICPersistOptionsStrictFormat = 0x2,
    WICPersistOptionsNoCacheStream = 0x4,
