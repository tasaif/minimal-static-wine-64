/*** Autogenerated by WIDL 1.7.40 from xaudio2.idl - Do not edit ***/
...
static FORCEINLINE void IXAudio2SourceVoice_GetState(IXAudio2SourceVoice* This,XAUDIO2_VOICE_STATE *pVoiceState) {
...
/*** IXAudio2 methods ***/
#define IXAudio2_GetDeviceCount(This,pCount) (This)->lpVtbl->GetDeviceCount(This,pCount)
...
/*** IXAudio2 methods ***/
static FORCEINLINE HRESULT IXAudio2_GetDeviceCount(IXAudio2* This,UINT32 *pCount) {
    return This->lpVtbl->GetDeviceCount(This,pCount);
}
static FORCEINLINE HRESULT IXAudio2_GetDeviceDetails(IXAudio2* This,UINT32 Index,XAUDIO2_DEVICE_DETAILS *pDeviceDetails) {
    return This->lpVtbl->GetDeviceDetails(This,Index,pDeviceDetails);
}
static FORCEINLINE HRESULT IXAudio2_Initialize(IXAudio2* This,UINT32 Flags,XAUDIO2_PROCESSOR XAudio2Processor) {
...
static FORCEINLINE HRESULT IXAudio2_CreateMasteringVoice(IXAudio2* This,IXAudio2MasteringVoice **ppMasteringVoice,UINT32 InputChannels,UINT32 InputSampleRate,UINT32 Flags,UINT32 DeviceIndex,const XAUDIO2_EFFECT_CHAIN *pEffectChain) {
...
HRESULT STDMETHODCALLTYPE IXAudio2_GetDeviceCount_Proxy(
    IXAudio2* This,
    UINT32 *pCount);
void __RPC_STUB IXAudio2_GetDeviceCount_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IXAudio2_GetDeviceDetails_Proxy(
    IXAudio2* This,
    UINT32 Index,
    XAUDIO2_DEVICE_DETAILS *pDeviceDetails);
void __RPC_STUB IXAudio2_GetDeviceDetails_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IXAudio2_Initialize_Proxy(
    IXAudio2* This,
    UINT32 Flags,
    XAUDIO2_PROCESSOR XAudio2Processor);
void __RPC_STUB IXAudio2_Initialize_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
